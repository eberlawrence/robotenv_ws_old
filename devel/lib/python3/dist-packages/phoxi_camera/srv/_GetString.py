...
"""autogenerated by genpy from phoxi_camera/GetStringRequest.msg. Do not edit."""
import codecs
import sys
...
class GetStringRequest(genpy.Message):
  ...
  _type = "phoxi_camera/GetStringRequest"
...
def _get_struct_I():
    ...
    return _struct_I
# This Python file uses the following encoding: utf-8
"""autogenerated by genpy from phoxi_camera/GetStringResponse.msg. Do not edit."""
import codecs
import sys
python3 = True if sys.hexversion > 0x03000000 else False
import genpy
...
class GetStringResponse(genpy.Message):
  _md5sum = "433bf658b0146fb6dd240f5d5c05b01c"
  _type = "phoxi_camera/GetStringResponse"
  _has_header = False  # flag to mark the presence of a Header object
  _full_text = """string value
string message
bool success
"""
  __slots__ = ['value','message','success']
