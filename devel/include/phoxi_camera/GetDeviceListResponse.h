...
struct GetDeviceListResponse_
{
  ...
  _len_type len;
   ...
   typedef std::vector<std::basic_string<char, std::char_traits<char>, typename ContainerAllocator::template rebind<char>::other > , typename ContainerAllocator::template rebind<std::basic_string<char, std::char_traits<char>, typename ContainerAllocator::template rebind<char>::other > >::other >  _out_type;
  _out_type out;

   typedef std::vector< ::phoxi_camera::DeviceInformation_<ContainerAllocator> , typename ContainerAllocator::template rebind< ::phoxi_camera::DeviceInformation_<ContainerAllocator> >::other >  _device_information_list_type;
...
struct Printer< ::phoxi_camera::GetDeviceListResponse_<ContainerAllocator> >
{
  template<typename Stream> static void stream(Stream& s, const std::string& indent, const ::phoxi_camera::GetDeviceListResponse_<ContainerAllocator>& v)
  {
    ...
    {
      s << indent << "  out[" << i << "]: ";
      Printer<std::basic_string<char, std::char_traits<char>, typename ContainerAllocator::template rebind<char>::other > >::stream(s, indent + "  ", v.out[i]);
    }
